...
//        Date date = new Date();  
////        Employee e = new Employee(1, name.getText(), no.getText(), null, null, cv.getText(), Float.parseFloat(salary.getText()), Integer.valueOf(dept.getText()), BigInteger.valueOf(123));
//        return e;
//    }
